...
def chat():
    try:
        ...
        if user_message.lower().strip() == "bye":
            try:
                with open(r"C:\Users\USer\Documents\Lawyer Legal Bot\Lawyer Legal Bot\logs") as file:
                    log_content = file.read()

                email = (
                    EmailBuilder()
                    .from_email("", "AI Lawyer")
                    .to_many([{"email": "hamsavenigowda2004@gmail.com", "name": "hamsa"}])
